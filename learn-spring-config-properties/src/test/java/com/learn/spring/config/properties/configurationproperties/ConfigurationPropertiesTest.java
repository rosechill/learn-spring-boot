package com.learn.spring.config.properties.configurationproperties;

import com.learn.spring.config.properties.converter.StringToDateConverter;
import com.learn.spring.config.properties.properties.ApplicationProperties;
...
public class ConfigurationPropertiesTest {
    ...
    void testDatabaseProperties() {
        Assertions.assertEquals("bagas", properties.getDatabase().getUsername());
    ...
    @Test
    void testDatabaseCollectionProperties() {
